...
import type { SupplyRow } from "@/lib/subgraph";

type Props = { rows: SupplyRow[]; tokenDecimals?: number };
...
export default function SuppliesTable({ rows, tokenDecimals = 18 }: Props) {
  const explorer =
